import { Box, Button, Center, FormControl, HStack, Input, Stack, VStack } from '~/utils/chakra';
import Image from 'next/image';
import { ChangeEvent } from 'react';
import { NewsLetter } from './NewsLetter';
const DetailsSection = () => {
  return (
    <VStack backgroundColor="transparent" overflow="hidden" spacing="0" w="100%">
      <Center
        zIndex={'1'}
        w="100%"
      ...
      >
        <VStack
          ...
          gap="0.6rem"
        >
          <Box as="p" textStyle={{ base: 'headline3', sm: 'headline2', lg: 'display3' }}>
          ...
          <Box
            ...
            color="neutral.8"
          >
            With Cubik, you can create a project and start receiving funding in minutes.
          </Box>
        </VStack>
      </Center>
      <Box
      ...
      >
        ...
        >
          <Image src="/images/grid.png" alt="cubik grid" fill={false} width={1300} height={1200} />
        </Center>
      </Box>
      <Center w="full" backgroundColor="#000000" zIndex="1">
        ...
        >
          <Stack
            ...
            gap="4rem"
          >
            <VStack gap="1rem" zIndex={'1'} alignItems="start" position="relative" flex={'50%'}>
              ...
              <Box
                ...
                color="neutral.9"
              >
                Quadratic funding is a method of funding public goods that involves matching small
                individual contributions with larger matching funds.
              </Box>
            ...
            <VStack flex="50%" zIndex={'1'} gap="3rem" alignItems="start">
              <VStack alignItems="start">
                ...
                <Box as="p" textStyle={{ base: 'title4', md: 'title3' }} color="neutral.11">
                  Quadratic funding matches small individual contributions with larger funds from
                  donors.
                </Box>
              </VStack>
              <VStack alignItems="start">
                ...
                <Box as="p" textStyle={{ base: 'title4', md: 'title3' }} color="neutral.11">
                  Matching funds are allocated fairly, giving more weight to small donations through
                  a mathematical formula for greater impact from smaller donors.
                </Box>
              </VStack>
              <VStack alignItems="start">
                <Box color="brand.teal5" as="p" textStyle={'title6'}>
                ...
                <Box as="p" textStyle={{ base: 'title4', md: 'title3' }} color="neutral.11">
                  Quadratic funding encourages broad support from many small donors for public goods
                  and projects.
                </Box>
              </VStack>
            </VStack>
            <Center
              ...
              height="100%"
            >
              <Image src="/images/cube.png" alt="glass cube" layout="fill" objectFit="contain" />
            </Center>
          </Stack>
        </Center>
      </Center>
      ...
      >
        ...
        <VStack zIndex="1" textAlign={'center'} maxW="3xl" px="2rem" gap="2rem">
          <Box
            ...
            zIndex={'1'}
            sx={{
              bgGradient: 'linear-gradient(to-r, #ffffff00, #ffffff24, #ffffff00)',
            }}
            height="1px"
          />
          <Box as="p" textStyle={{ base: 'headline3', sm: 'headline2', lg: 'display3' }}>
