...
import { searchProjectsType } from '~/types/project';
...
export const SearchBar = ({ display, width }: SearchBarProps) => {
  ...
  return (
    <>
            ...
            <ModalBody w={'full'} rounded="8px" border="1px solid #1B181A" p="0">
              <VStack rounded="8px" gap="0" spacing="0" background={'#0F0F0F'}>
                <InputGroup
                  ...
                  onClick={onOpen}
                >
                  <InputLeftElement w="3.2rem" h="full" pointerEvents="none" bg="transparent">
                ...
                >
                  ...
                  {searchProjectMutation.isLoading ? (
                  ...
                  ) : filteredProjects.length === 0 && searchInput.trim() !== '' ? (
                    ...
                    >
                      {filteredProjects.map((projectjoinround, index) => (
                        <Link key={projectjoinround?.id} href={`/project/${projectjoinround?.id}`}>
                          <HStack
                            gap="8px"
                            rounded="8px"
                            w="full"
                            p="8px"
                            bg={index === selectedProjectIndex ? 'neutral.5' : 'transparent'}
                          ...
                          >
                            ...
                            <HStack justify={'start'} gap="0" align={'center'}>
                              ...
                              <Box as="p" color="neutral.8" fontSize={'11px'} lineHeight="12px">
      ...
      >
        <InputLeftElement w="3.5rem" h="full" pointerEvents="none" bg="transparent">
          <Box as={BiSearch} boxSize={{ base: '1.2rem', md: '1.4rem' }} color="#ffffff50" />
        </InputLeftElement>
